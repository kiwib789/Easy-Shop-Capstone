...
UPDATE products
SET price = 999.99, description = 'A high-performance laptop for work and entertainment.', image_url = 'laptop.jpg', stock = 30, featured = 0, color = 'Gray'
WHERE name = 'Laptop' AND category_id = 1;

UPDATE products
SET price = 999.99, description = 'A high-performance gaming laptop.', image_url = 'laptop.jpg', stock = 30, featured = 0, color = 'Gray'
WHERE name = 'Laptop' AND category_id = 1;

UPDATE products
SET price = 29.99, description = 'Brew a perfect cup of tea with this classic tea kettle.', image_url = 'tea-kettle.jpg', stock = 50, featured = 1, color = 'White'
WHERE name = 'Tea Kettle' AND category_id = 3;
